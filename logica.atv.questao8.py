...
print(f"Média das idades das pessoas com altura inferior a 1.50 é {somaIdade/mediaIdade * 100:.2f}%")
...
if corDeCabeloRuicomOlhoA <= 0:
    print("Não foram informadas pessoas com cabelo ruivo sem olhos azuis")
else:
    print(f"Foram iformadas {corDeCabeloRuicomOlhoA} pessoas com cabelo ruivo que nao contém olhos azuis ")